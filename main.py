...
class GameState():
    def __init__(self):
        self.state='first_level'
        self.window=window
    def first_level(self):
        global final,ghost,walls,demons,bullets,secretwall,bulletsamount,reloading,holy_water,door_open,label,finish
    ...
    def keyboard_bindings(self):
        global ghost,bulletsamount,play
...
walls.add(GameSprite(0,450,225,75,wall_horizontal))
walls.add(GameSprite(225,675,225,75,wall_horizontal))
walls.add(GameSprite(450,675,225,75,wall_horizontal))
walls.add(GameSprite(375,525,225,75,wall_horizontal))
walls.add(GameSprite(225,75,225,75,wall_horizontal))
walls.add(GameSprite(225,225,225,75,wall_horizontal))
walls.add(GameSprite(450,75,225,75,wall_horizontal))
walls.add(GameSprite(675,75,225,75,wall_horizontal))
walls.add(GameSprite(825,450,225,75,wall_horizontal))
walls.add(GameSprite(525,225,225,75,wall_horizontal))
walls.add(GameSprite(225,375,75,225,wall_vertical))
walls.add(GameSprite(675,300,75,225,wall_vertical))
walls.add(GameSprite(375,300,75,225,wall_vertical))
walls.add(GameSprite(525,300,75,225,wall_vertical))
walls.add(GameSprite(150,75,75,225,wall_vertical))
walls.add(GameSprite(825,150,75,225,wall_vertical))
